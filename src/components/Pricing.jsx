...
import { plans } from "../data/CodeDataPricing";
const Pricing = () => {
  return (
    <section id="pricing" className="py-16 sm:py-20 sm:px-6 lg:px-8 relative">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <h2 className="text-5xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 lg:mb-8 leading-tight">
          ...
          <p className="text-gray-400 text-base sm:text-lg">
            Choose the plan that best fits your needs and start building today.
          </p>
        </div>
            ...
            >
              ...
              {plan.mostPopular && (
                <div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2 z-10">
                  <div className="flex items-center space-x-1 px-3 sm:px-4 py-1 sm:py-1.5 bg-linear-to-b from-blue-600 to-cyan-500 rounded-full text-xs sm:text-sm font-semibold text-white shadow-lg">
              ...
              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 grow">
                {plan.features.map((feature, feartureKey) =>(
                  <li key={feartureKey} className="flex items-start space-x-2 sm:space-x-3">
                    <div className="shrink-0 w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center mt-1 sm:mt-0.5">
                      <Check className="w-2.5 h-2.5 sm:w-3 text-blue-400"/>
                    </div>
