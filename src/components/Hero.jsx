...
const Hero = () => {
  // STATE: Vị trí chuột và tab đang active
  const [mousePosition, setMousePosition] = useState({ x: 0, y: 0 });
  const [activeTab, setActiveTab] = useState("App.jsx");

  // EFFECT: Theo dõi di chuyển chuột
  useEffect(() => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      {/* ==================== PHẦN 1: BACKGROUND EFFECTS ==================== */}
      {/* Gradient di chuyển theo chuột */}
      <div
          ...
          <div className="relative order-2 w-full">
            <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
              <div className="bg-linear-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[280px] sm:h-[350px] lg:h-[450px] border border-white/5">
                ...
                {/* IDE HEADER: 3 nút đóng/mở + title */}
                ...
                <div className="p-3 sm:p-4 relative h-full">
                  ...
                  {/* FILE TABS: Chọn file để xem code */}
                  ...
                  {/* CODE DISPLAY: Hiển thị code với syntax highlighting */}
              ...
              {/* FLOATING CARD: Thẻ thông tin nổi bên ngoài code editor */}
              <div
